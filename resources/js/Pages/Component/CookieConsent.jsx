                    ...
                    <section className="w-full p-5 lg:px-24 absolute top-0 bg-gray-200">
                        <div className="md:flex items-center -mx-3">
                            <div className="md:flex-1 px-3 mb-5 md:mb-0">
                                <p className="text-center md:text-left text-gray-600 text-xs leading-tight md:pr-12">We and selected partners and related companies, use cookies and similar technologies as specified in our Cookies Policy. You agree to consent to the use of these technologies by clicking Accept, or by continuing to browse this website. You can learn more about how we use cookies and set cookie preferences in Settings.</p>
                            </div>
                            <div className="px-3 text-center">
                                ...
                                <button id="btn" onClick={handleAccept} className="py-2 px-8 bg-yellow-600 hover:bg-yellow-500 text-white rounded font-bold text-sm shadow-xl">
                                    Accept cookies
                                </button>
                            </div>
                        </div >
