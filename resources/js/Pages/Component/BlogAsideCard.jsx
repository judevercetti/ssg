        ...
        <div className="py-2 border-t-2 border-gray-100">
            <div className="flex space-x-3 items-center">
                <div className="lg:w-auto lg:mr-2 mb-1 lg:mb-0">
                    <img className="w-32 md:w-40 h-20 object-cover" src={'/' + image} alt="" />
                </div>
                <div className="w-full lg:w-9/12 mb-2 lg:mb-0">
                    ...
                    <span className="text-sm font-semibold text-gray-900 line-clamp-3 hover:underline cursor-pointer">{title}</span>
                </div>
